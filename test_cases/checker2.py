...
def MuskLibraryTest(book_titles, texts):
    ...
    print(mlib.distinct_words("TheMazeRunner"))
    print(mlib.count_distinct_words("GoneGirl"))
    print(mlib.search_keyword("is"))
    mlib.print_books()
    print("-" * 350)
...
def JobsLibraryTest(book_titles, texts):
    ...
    print(jlib.distinct_words("SherlockHolmes"))
    print(jlib.count_distinct_words("ThePictureOfDorianGray"))
    print(jlib.search_keyword("who"))
    jlib.print_books()
    print("-" * 350)
...
def GatesLibraryTest(book_titles, texts):
    ...
    print(glib.distinct_words("Dracula"))
    print(glib.count_distinct_words("TheRoad"))
    print(glib.search_keyword("to"))
    glib.print_books()
    print("-" * 350)
...
def BezosLibraryTest(book_titles, texts):
    ...
    print(blib.distinct_words("DonQuixote"))
    print(blib.count_distinct_words("TheThreeMusketeers"))
    print(blib.search_keyword("with"))
    blib.print_books()
    print("-" * 350)
...
def run_code():
    book_titles, texts = read_data("inpu.txt")
